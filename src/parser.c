...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(117),
  ...
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(121),
  [34] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(137),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component_body, 1, 0, 0),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__source_block, 2, 0, 0),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(113),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(156),
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(127),
  ...
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_primary, 1, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expression_primary, 1, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_component_reference, 1, 0, 0),
  ...
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__constant_definition, 1, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__constant_definition, 1, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(165),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__index, 1, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__index, 1, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_open_right, 2, 0, 7),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_open_right, 2, 0, 7),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(163),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0),
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(156),
  [115] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(127),
  [118] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(137),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declaration_right, 1, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declaration_right, 1, 0, 0),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statements, 1, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statements, 1, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant, 3, 0, 10),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_constant, 3, 0, 10),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_closed, 3, 0, 9),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_closed, 3, 0, 9),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assignment_right, 1, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__assignment_right, 1, 0, 0),
  ...
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_open_left, 2, 0, 6),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_open_left, 2, 0, 6),
  [165] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(176),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0),
  [170] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(121),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_component, 4, 0, 11),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_component, 4, 0, 11),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_subscript, 3, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_subscript, 3, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_binary, 3, 0, 3),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_binary, 3, 0, 3),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_unary, 2, 0, 8),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_unary, 2, 0, 8),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_primary, 3, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expression_primary, 3, 0, 0),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__signal_definition, 1, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__signal_definition, 1, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(150),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_component_input, 1, 0, 0),
  [217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_left_list, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration_left_list, 2, 0, 0),
  ...
  [233] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_left_list_repeat1, 2, 0, 0), SHIFT_REPEAT(129),
  ...
  [240] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_left_list_repeat1, 2, 0, 0), SHIFT_REPEAT(130),
  ...
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_right_list, 2, 0, 0),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration_right_list, 2, 0, 0),
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_right_list, 2, 0, 0),
  [261] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_right_list, 2, 0, 0),
  [263] = {.entry = {.count = 1, .reusable = true}}, SHIFT(151),
  [265] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component_output_list, 2, 0, 0),
  [269] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__component_output_list, 2, 0, 0),
  [271] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [273] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [276] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [279] = {.entry = {.count = 1, .reusable = true}}, SHIFT(158),
  [281] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_outputs, 1, 0, 0),
  [285] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component_outputs, 1, 0, 0),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__component_output_list_repeat1, 2, 0, 0),
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__component_output_list_repeat1, 2, 0, 0),
  [291] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__component_output_list_repeat1, 2, 0, 0), SHIFT_REPEAT(97),
  ...
  [308] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0), SHIFT_REPEAT(112),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__comments, 1, 0, 0),
  [315] = {.entry = {.count = 1, .reusable = true}}, SHIFT(114),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__comments, 1, 0, 0),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0),
  [321] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0), SHIFT_REPEAT(114),
  ...
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 9, 0, 13),
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 9, 0, 13),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 8, 0, 12),
  [342] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 8, 0, 12),
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_component_input_list, 2, 0, 0),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_inputs, 1, 0, 0),
  [348] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [350] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component_input_list, 2, 0, 0),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__component_input_list_repeat1, 2, 0, 0),
  [354] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__component_input_list_repeat1, 2, 0, 0), SHIFT_REPEAT(107),
  [357] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assignment_left_list_repeat1, 2, 0, 0), SHIFT_REPEAT(142),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assignment_left_list_repeat1, 2, 0, 0),
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_reference, 2, 0, 0),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__reference, 1, 0, 0),
  [366] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [368] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [371] = {.entry = {.count = 1, .reusable = true}}, SHIFT(142),
  [373] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assignment_left, 1, 0, 0),
  [375] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_component_reference_repeat1, 2, 0, 0),
  [377] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_component_reference_repeat1, 2, 0, 0), SHIFT_REPEAT(160),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_left_list, 2, 0, 0),
