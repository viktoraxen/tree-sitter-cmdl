...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [23] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(116),
  ...
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(119),
  [34] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(134),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__source_block, 2, 0, 0),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(111),
  [42] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(147),
  [45] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__source_block, 2, 0, 0), SHIFT_REPEAT(110),
  [48] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component_body, 1, 0, 0),
  ...
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_primary, 1, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expression_primary, 1, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_component_reference, 1, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(166),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_open_right, 2, 0, 7),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_open_right, 2, 0, 7),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__constant_definition, 1, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__constant_definition, 1, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(169),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__index, 1, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__index, 1, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_open_left, 2, 0, 6),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_open_left, 2, 0, 6),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declaration_right, 1, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declaration_right, 1, 0, 0),
  ...
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range_closed, 3, 0, 9),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range_closed, 3, 0, 9),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(163),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant, 3, 0, 10),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_constant, 3, 0, 10),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assignment_right, 1, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__assignment_right, 1, 0, 0),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0),
  [150] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(147),
  [153] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(110),
  [156] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(134),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statements, 1, 0, 0),
  [163] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(176),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0),
  [168] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statements_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statements, 1, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_unary, 2, 0, 8),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_unary, 2, 0, 8),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_primary, 3, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expression_primary, 3, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_component, 4, 0, 11),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_component, 4, 0, 11),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_binary, 3, 0, 3),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_binary, 3, 0, 3),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_subscript, 3, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_subscript, 3, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_component_input, 1, 0, 0),
  ...
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_declaration_left_list_repeat1, 2, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_declaration_left_list_repeat1, 2, 0, 0),
  [237] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_left_list_repeat1, 2, 0, 0), SHIFT_REPEAT(130),
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declaration_left, 1, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declaration_left, 1, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(130),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_left_list, 2, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration_left_list, 2, 0, 0),
  [255] = {.entry = {.count = 1, .reusable = true}}, SHIFT(129),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_signal_definition, 3, 0, 4),
  [259] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_signal_definition, 3, 0, 4),
  ...
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_right_list, 2, 0, 0),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_right_list, 2, 0, 0),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_outputs, 1, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component_outputs, 1, 0, 0),
  [281] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [283] = {.entry = {.count = 1, .reusable = true}}, SHIFT(161),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__component_output_list_repeat1, 2, 0, 0),
  [287] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__component_output_list_repeat1, 2, 0, 0),
  [289] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__component_output_list_repeat1, 2, 0, 0), SHIFT_REPEAT(85),
  [292] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component_output_list, 2, 0, 0),
  [297] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__component_output_list, 2, 0, 0),
  [299] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__comments, 1, 0, 0),
  [304] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [306] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__comments, 1, 0, 0),
  [308] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0), SHIFT_REPEAT(113),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 2, 0, 1),
  [315] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 2, 0, 1),
  [317] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [319] = {.entry = {.count = 1, .reusable = true}}, SHIFT(113),
  [321] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0),
  [325] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__comments_repeat1, 2, 0, 0), SHIFT_REPEAT(118),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 3),
  [330] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment, 3, 0, 3),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 4, 0, 5),
  [334] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 4, 0, 5),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 8, 0, 12),
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 8, 0, 12),
  [340] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 9, 0, 13),
  [342] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 9, 0, 13),
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_inputs, 1, 0, 0),
  [346] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_component_reference_repeat1, 2, 0, 0),
  [350] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_component_reference_repeat1, 2, 0, 0), SHIFT_REPEAT(166),
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__component_input_list, 2, 0, 0),
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__reference, 1, 0, 0),
  [357] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [359] = {.entry = {.count = 1, .reusable = true}}, SHIFT(139),
  [361] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assignment_left, 1, 0, 0),
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_reference, 2, 0, 0),
  [365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_component_input_list, 2, 0, 0),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__component_input_list_repeat1, 2, 0, 0),
  [369] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__component_input_list_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [372] = {.entry = {.count = 1, .reusable = true}}, SHIFT(134),
  [374] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assignment_left_list_repeat1, 2, 0, 0), SHIFT_REPEAT(139),
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assignment_left_list_repeat1, 2, 0, 0),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_left_list, 2, 0, 0),
  [381] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declaration_right_list_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
